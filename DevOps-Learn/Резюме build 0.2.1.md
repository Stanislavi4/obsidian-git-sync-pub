...
Обязанности в подробностях:
		Системный администратор Безопасности сети ООО ТК "Агро-Инвест"
			 ...
			 Администрировал, диагностировал неисправности в семействах Windows ОС. PS Get-EventLog, Get-WinEvent, методом черного ящика через просмотр wireshark, F12 "средство разработчика"
			 у
