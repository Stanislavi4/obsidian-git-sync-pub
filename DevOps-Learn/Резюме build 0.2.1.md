...
Обязанности в подробностях:
		Системный администратор Безопасности сети ООО ТК "Агро-Инвест"
			 Настраивал, ремонтировал маршрутизаторы на основе Linux (Centos 7) для обеспечения туннельного соединения между филиалами организации. (iptables, cat var/log, inode, )
			 Администрировал, диагностировал неисправности в семействах Windows ОС. (PS Get-EventLog, Get-WinEvent, методом черного ящика через просмотр wireshark, DevTools web.)
