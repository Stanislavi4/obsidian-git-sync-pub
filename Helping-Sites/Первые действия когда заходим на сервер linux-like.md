...
chown -  используется для изменения владельца и группы файлов или директорий. Она принимает два аргумента (UID) пользователя, и номер GID-группового идентификатора
```
